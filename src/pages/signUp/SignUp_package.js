...
function SignUp_package() {
  ...
  return (
    ...
    <div className="container">
      ...
      <Card.Header className="border-0" style={{ height: '180px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between',
       background: 'linear-gradient(90deg, #e6f5ff, #d5eeff)' , paddingLeft : '80px', paddingRight : '30px', paddingBottom :'30px'}}><div className='mt-3' style={{ fontSize: '14px', textAlign: 'left' }}>기업에서 자주 사용하는 서비스들을 모아서 제공하는 플랜입니다.<br></br>
      ...
      <Col>
        ...
        <Col>
          ...
          <Col sm={5}>
    <Card className="text-center border-0">
      <Card.Header style={{ height: '180px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between',
       background: 'linear-gradient(90deg, #e6f5ff, #d5eeff)', paddingLeft : '80px', paddingRight : '80px'}}><img src="https://static.wehago.com/imgs/cw/plan_new_bg04.png" style={{ maxWidth: '100%', maxHeight: '150px' }} alt="이미지 설명" /></Card.Header>
